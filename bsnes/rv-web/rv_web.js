/* @ts-self-types="./rv_web.d.ts" */

/**
 * @param {Uint8Array} game
 */
export function worker_main(game) {
    const ptr0 = passArray8ToWasm0(game, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.worker_main(ptr0, len0);
    if (ret[1]) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_0e58993b12257103: function() {
            const ret = new Array();
            return ret;
        },
        ...
        __wbg_performance_4fbbe01fde1f4e29: function(arg0) {
            const ret = arg0.performance;
            return isLikeNone(ret) ? 0 : addToExternrefTable0(ret);
        },
        __wbg_postMessage_8b9c953371c75fe6: function() { return handleError(function (arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rv_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
